...
class Brief
{
    ...
    private ?Livrable $livrable = null;
    ...
    public function set_livrable(?Livrable $livrable)
    {
        $this->livrable = $livrable;
    }

    public function get_livrable()
    {
    ...
    {
        return $this->livrable !== null;
    }

    public function get_repo_link()
    {
        return $this->livrable?->get_url();
    }

    public function set_review_status(?string $status)
    {
